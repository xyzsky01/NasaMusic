...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("tentangsayaa01")
                await self.six.join_chat("tentangsayaa01")
            except:
                pass
            assistants.append(6)
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("tentangsayaa01")
                await self.seven.join_chat("tentangsayaa01")
            except:
                pass
            assistants.append(7)
        ...
        if config.STRING8:
            ...
            try:
                await self.eight.join_chat("tentangsayaa01")
                await self.eight.join_chat("tentangsayaa01")
            except:
                pass
            assistants.append(8)
        ...
        if config.STRING9:
            ...
            try:
                await self.nine.join_chat("tentangsayaa01")
                await self.nine.join_chat("tentangsayaa01")
            except:
                pass
            assistants.append(9)
        ...
        if config.STRING10:
            ...
            try:
                await self.ten.join_chat("tentangsayaa01")
                await self.ten.join_chat("tentangsayaa01")
            except:
                pass
            assistants.append(9)
